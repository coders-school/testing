...
SCENARIO("First frame calculations"){
    ...
    GIVEN("First ball knocks down 0, second ball knocks down 10 pins, first frame "
      ...
      WHEN("Second frame played with 9 score") {
        THEN("First frame is a 'spare'.") {
            CHECK("score for first frame is 19") }
      }
    }

    GIVEN("First ball in first frame knocks down 10 pins, first frame is over.") {
...
SCENARIO("Last frame calculations") {
